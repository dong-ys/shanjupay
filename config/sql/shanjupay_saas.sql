...
CREATE TABLE `account_role` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='账号-角色关系';
...
VALUES
  (1,'商户管理员','r_001',1177111672565059586),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色-权限关系';
...
CREATE TABLE `resource_application` (
  ...
  `TENANT_ID` bigint(20) DEFAULT NULL COMMENT '租户id',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='应用信息';
...
VALUES
  (1,'闪聚支付-商户平台','merchant-platform',1),
  (2,'闪聚支付-运营平台','operation-platform',1),
  (3,'门户','portal-site',1),
...
CREATE TABLE `resource_button` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='按钮资源';

LOCK TABLES `resource_button` WRITE;
/*!40000 ALTER TABLE `resource_button` DISABLE KEYS */;

INSERT INTO `resource_button` (`ID`, `PARENT_ID`, `TITLE`, `URL`, `ICON`, `SORT`, `COMMENT`, `STATUS`, `APPLICATION_CODE`, `PRIVILEGE_CODE`, `PCODE`)
VALUES
  (1241761810982985001,NULL,'工作台-升级',NULL,NULL,2,NULL,1,'merchant-platform','sj_m_console_upgrade','sj_m_console_upgrade'),
  (1241761810982985002,NULL,'工作台-续费',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_console_renew','sj_m_console_renew'),
  (1241761810982985003,NULL,'创建应用',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_app_create','sj_m_app_create'),
  (1241761810982985004,NULL,'保存应用',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_app_save','sj_m_app_save'),
  (1241761810982985005,NULL,'编辑应用',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_app_edit','sj_m_app_edit'),
  (1241761810982985010,NULL,'支付参数保存',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_payparam_save','sj_m_payparam_save'),
  (1241761810982985011,NULL,'设置默认支付',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_pay_set','sj_m_pay_set'),
  (1241761810982985012,NULL,'保存默认支付',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_pay_save','sj_m_pay_save'),
  (1241761810982985013,NULL,'C扫B二维码',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_c2b_qrcode','sj_m_c2b_qrcode'),
  (1241761810982985014,NULL,'B扫C订单',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_b2c_order','sj_m_b2c_order'),
  (1241761810982985015,NULL,'购买套餐',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_bundle_buy','sj_m_bundle_buy'),
  (1241761810982985017,NULL,'企业认证资料提交',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_enterprise_info_submit','sj_m_enterprise_info_submit'),
  (1241761810982985018,NULL,'会员查询',NULL,NULL,1,NULL,1,'merchant-platform','sj_o_member_query','sj_o_member_query'),
  (1241761810982985019,NULL,'审核管理企业查询',NULL,NULL,1,NULL,1,'merchant-platform','sj_o_enterprise_query','sj_o_enterprise_query'),
  (1241761810982985021,NULL,'门店管理-新建按钮',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_store_create','sj_m_store_create'),
  (1241761810982985022,NULL,'门店管理-编辑按钮',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_store_edit','sj_m_store_edit'),
  (1241761810982985023,NULL,'门店管理-删除按钮',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_store_del','sj_m_store_del'),
  (1241761810982985024,NULL,'门店管理-查询按钮',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_store_query','sj_m_store_query'),
  (1241761810982985025,NULL,'门店管理-保存按钮',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_store_save','sj_m_store_save'),
  (1241761810982985026,NULL,'成员管理-新建按钮',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_staff_create','sj_m_staff_create'),
  (1241761810982985027,NULL,'成员管理-编辑按钮',NULL,NULL,1,NULL,1,'merchant-platform','sj_m_staff_edit','sj_m_staff_edit'),
...
INSERT INTO `resource_menu` (`ID`, `PARENT_ID`, `TITLE`, `URL`, `ICON`, `SORT`, `COMMENT`, `STATUS`, `APPLICATION_CODE`, `PRIVILEGE_CODE`, `PCODE`)
VALUES
  (1,NULL,'商户后台',NULL,NULL,1,NULL,1,'',NULL,NULL),
...
VALUES
  (1,'系统管理组织','admin'),
  (2,'闪聚支付-运营商','shanju-operation'),
  (3,'闪聚支付-签约商户','shanju-merchant');
